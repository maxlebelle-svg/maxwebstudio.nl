...
insert into public.factory_projects(id,relationship_type,relationship_id,factory_type,blueprint_key,blueprint_version,name,status,created_by,updated_at) values
  ('40000000-0000-4000-8000-000000000001','customer','30000000-0000-4000-8000-000000000001','food','food-pickup-v1',1,'Standard gate','review','20000000-0000-4000-8000-000000000002','2026-07-29T20:00:00Z'),
  ('40000000-0000-4000-8000-000000000002','customer','30000000-0000-4000-8000-000000000001','food','food-pickup-v1',1,'Override gate','review','20000000-0000-4000-8000-000000000002','2026-07-29T20:00:00Z'),
  ('40000000-0000-4000-8000-000000000003','customer','30000000-0000-4000-8000-000000000001','food','food-pickup-v1',1,'Missing gate','review','20000000-0000-4000-8000-000000000002','2026-07-29T20:00:00Z'),
  ('40000000-0000-4000-8000-000000000004','customer','30000000-0000-4000-8000-000000000001','food','food-pickup-v1',1,'Changed gate','review','20000000-0000-4000-8000-000000000002','2026-07-29T20:00:00Z');
...
from (values
 ('restaurant_tenant','food_foundation','food_demo_bundle'),('menu_opening_hours','food_foundation','food_runtime_catalog'),('manager_tenant_isolation','access','food_access_context'),
 ('order_route','experience','food_demo_bundle'),('dashboard_view','experience','food_demo_bundle'),('mobile_validation','experience','food_storefront_probe'),
 ('domain_mapping','domain','domain_center'),('dns_verified','domain','domain_center'),('ssl_active','domain','domain_center'),('business_email_preserved','domain','domain_center'),
 ('mollie_connected','commerce','commerce'),('legal_set','legal','legal_registry'),('internal_approval','approval','internal_attestation'),
...
insert into public.factory_gate_overrides(factory_project_id,reason,open_risks,created_by)
values('40000000-0000-4000-8000-000000000002','Controlled local superadmin exception','["All fifteen production proofs remain open"]','20000000-0000-4000-8000-000000000001');
...
from (values
 ('restaurant_tenant','food_foundation','food_demo_bundle'),('menu_opening_hours','food_foundation','food_runtime_catalog'),('manager_tenant_isolation','access','food_access_context'),('order_route','experience','food_demo_bundle'),('dashboard_view','experience','food_demo_bundle'),('mobile_validation','experience','food_storefront_probe'),('domain_mapping','domain','domain_center'),('dns_verified','domain','domain_center'),('ssl_active','domain','domain_center'),('business_email_preserved','domain','domain_center'),('mollie_connected','commerce','commerce'),('legal_set','legal','legal_registry'),('internal_approval','approval','internal_attestation'),('customer_approval','approval','customer_approval_registry'),('environment_mode','release','factory_context')
) checks(key_name,group_name,source_name);
