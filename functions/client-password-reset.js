...
function buildPasswordResetEmailHtml(email, mailPreview) {
  ...
  return `<!doctype html><html lang="nl"><head><meta charset="utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1" /><meta name="color-scheme" content="dark" /><meta name="supported-color-schemes" content="dark" /><title>${escapeHtml(mailPreview.subject)}</title><style>:root{color-scheme:dark;supported-color-schemes:dark}.mws-bg{background:#07111f!important;background-image:linear-gradient(#07111f,#07111f)!important}.mws-card{background:#0b1728!important;background-image:linear-gradient(#0b1728,#0b1728)!important}.mws-text{color:#d7e3f7!important}.mws-title{color:#ffffff!important}.mws-link{color:#7db7ff!important}</style></head><body class="mws-bg" bgcolor="#07111f" style="margin:0;background:#07111f!important;background-image:linear-gradient(#07111f,#07111f)!important;color:#eaf1ff;font-family:Arial,sans-serif;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" bgcolor="#07111f" class="mws-bg" style="background:#07111f!important;background-image:linear-gradient(#07111f,#07111f)!important;padding:32px 20px;"><tr><td align="center" bgcolor="#07111f" style="background:#07111f!important;background-image:linear-gradient(#07111f,#07111f)!important;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" bgcolor="#0b1728" class="mws-card" style="max-width:640px;border:1px solid rgba(255,255,255,0.12);border-radius:18px;background:#0b1728!important;background-image:linear-gradient(#0b1728,#0b1728)!important;"><tr><td bgcolor="#0b1728" class="mws-card" style="padding:28px;background:#0b1728!important;background-image:linear-gradient(#0b1728,#0b1728)!important;"><p class="mws-link" style="margin:0 0 10px;color:#7db7ff!important;font-size:13px;font-weight:700;letter-spacing:.04em;text-transform:uppercase;">${escapeHtml(companySettings.companyName)}</p><h1 class="mws-title" style="margin:0 0 20px;color:#ffffff!important;font-size:28px;line-height:1.2;">Nieuw wachtwoord instellen</h1><p class="mws-text" style="margin:0 0 14px;color:#d7e3f7!important;font-size:15px;line-height:1.7;">We hebben een aanvraag ontvangen om het wachtwoord voor <strong style="color:#ffffff!important;">${escapeHtml(email)}</strong> opnieuw in te stellen.</p><p class="mws-text" style="margin:0 0 14px;color:#d7e3f7!important;font-size:15px;line-height:1.7;">Gebruik onderstaande knop om veilig een nieuw wachtwoord te kiezen. Heb jij dit niet aangevraagd? Dan hoef je niets te doen.</p><p style="margin:24px 0 0;"><a href="${actionLink}" style="display:inline-block;background:#2f8cff!important;background-image:linear-gradient(#2f8cff,#2f8cff)!important;color:#ffffff!important;text-decoration:none;border-radius:10px;padding:12px 18px;font-weight:700;">${buttonLabel}</a></p><p style="margin:18px 0 0;color:#91a6bc!important;font-size:13px;line-height:1.6;">Werkt de knop niet? Open dan deze link:<br /><a class="mws-link" href="${actionLink}" style="color:#7db7ff!important;">${actionLink}</a></p><p class="mws-text" style="margin:24px 0 0;color:#d7e3f7!important;font-size:15px;line-height:1.7;">Vragen? Mail naar <a class="mws-link" href="${escapeAttribute(getMailtoLink(companySettings, "Vraag over wachtwoord reset"))}" style="color:#7db7ff!important;">${escapeHtml(companySettings.primaryEmail)}</a>.</p></td></tr></table></td></tr></table></body></html>`;
}
