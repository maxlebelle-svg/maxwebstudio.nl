...
function checkArtifacts() {
  ...
  const rows = [
    ...
    { id: "ceo-ui", label: "CEO Mode UI", file: "admin-dashboard.html", critical: false },
...
function buildSubsystemChecks({ environment, supabase, functions, artifacts }) {
  ...
  return [
    ...
    card("ceo-mode", "CEO Mode", ceoReady.status, "CEO dashboardwidgets beschikbaar.", ceoReady.latencyMs, false),
