...
<body bgcolor="#030b14" style="margin:0;background:#030b14;color:#ffffff;font-family:Inter,Arial,sans-serif;"><div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;">Je persoonlijke demo en voorstel van Max Webstudio staan klaar.</div>
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="mws-shell" bgcolor="#030b14" style="background:#030b14;padding:30px 14px;"><tr><td align="center"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="mws-card" bgcolor="#071b2c" style="max-width:680px;background:#071b2c;border:1px solid #163d58;border-top:4px solid #24d3ee;border-radius:20px;overflow:hidden;">
${bannerRow}<tr><td class="mws-pad" bgcolor="#061523" style="padding:27px 30px 20px;background:#061523;border-bottom:1px solid #163d58;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td width="52" bgcolor="#030b14" style="width:52px;height:52px;border-radius:12px;background:#030b14;text-align:center;"><img src="${LOGO_URL}" width="46" height="46" alt="Max Webstudio" style="display:block;margin:3px auto;border:0;width:46px;height:46px;"></td><td style="padding-left:14px;"><div style="font-size:20px;color:#ffffff;font-weight:900;">Max Webstudio</div><div style="margin-top:3px;font-size:10px;color:#24d3ee;font-weight:900;letter-spacing:.18em;text-transform:uppercase;">BUILD BETTER ONLINE</div></td><td align="right" style="color:#8eefff;font-size:11px;font-weight:900;letter-spacing:.1em;text-transform:uppercase;">${definitiveOffer ? "Definitieve offerte" : "Persoonlijk voorstel"}</td></tr></table></td></tr>
