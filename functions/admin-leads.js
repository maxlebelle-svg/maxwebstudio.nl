...
async function readLeadRows({ supabaseUrl, serviceRoleKey, id = "" }) {
  const selects = [
    ...
    "id,company_name,contact_name,email,phone,website,status,lead_status,pipeline_stage,interest_level,priority,is_favorite,archived_at,assigned_user_id,assigned_at,assigned_by,normalized_company_name,normalized_phone,external_source,external_source_id,acquisition_channel,sourced_by_user_id,closed_by_user_id,last_activity_at,last_contacted_at,last_contacted_by,last_call_outcome,next_action_type,next_action_at,next_action_note,next_action_assigned_user_id,next_action_created_automatically,next_action_completed_at,next_action_completed_by,appointment_at,appointment_type,appointment_location,won_at,won_by,lost_at,lost_by,lost_reason,lost_note,owner_id,created_by,assigned_to,notes,is_demo,environment,metadata,created_at,updated_at",
    "id,company_name,contact_name,email,phone,website,status,lead_status,assigned_user_id,assigned_at,assigned_by,normalized_company_name,normalized_phone,external_source,external_source_id,acquisition_channel,sourced_by_user_id,closed_by_user_id,last_activity_at,last_contacted_at,last_contacted_by,last_call_outcome,next_action_type,next_action_at,next_action_note,next_action_assigned_user_id,next_action_created_automatically,appointment_at,appointment_type,appointment_location,won_at,won_by,lost_at,lost_by,lost_reason,lost_note,owner_id,created_by,assigned_to,notes,is_demo,environment,metadata,created_at,updated_at",
