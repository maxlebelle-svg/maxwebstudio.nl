...
const PROFILES = [
  ...
  profile("bakery", {
    industry: "retail", subcategory: "bakkerij", assetGroup: "restaurant",
    aliases: ["bakker", "bakkerij", "thuisbakkerij", "patisserie", "patissier", "taart", "taarten", "cupcakes", "macarons", "gebak"],
    positiveSignals: ["huisgemaakt", "bakkerij", "thuisbakkerij", "patisserie", "taart", "cupcake", "macaron", "meringue", "honey cake", "bestellen", "bezorgen"],
    negativeSignals: ["reserveren", "tafel boeken", "diner", "lunchmenu", "bouw", "behandeling"],
    targetAudience: ["particulieren die huisgemaakte zoetigheden bestellen"],
    personality: ["warm", "feestelijk", "persoonlijk", "ambachtelijk"], tone: ["warm", "smakelijk", "duidelijk"],
    trustSignals: ["huisgemaakt", "vers op bestelling", "persoonlijk contact", "duidelijke levering"],
    visualStyle: ["productgericht", "warm", "feestelijk"], colorPalette: ["#2b1d20", "#8f3f58", "#d39157", "#fff8f1"],
    preferredPhotoTags: ["bakery", "cake", "cupcake", "macaron", "patisserie", "dessert"], forbiddenPhotoTags: ["office", "construction", "healthcare", "restaurant-interior"],
    services: ["Taarten", "Macarons", "Cupcakes", "Meringuerol", "Honey Cake", "Bestellen en bezorgen"],
    preferredSections: ["hero", "categorieen", "producten", "over-ons", "reviews", "bestellen", "contact"], forbiddenSections: ["reserveren", "projecten", "behandelingen"],
    ctaExamples: ["Bekijk het assortiment", "Bestel of stel een vraag"],
    copyGuidelines: ["schrijf productgericht", "gebruik geen restaurant- of projecttaal", "neem alleen aantoonbare bezorgclaims over"],
    primaryTopics: ["huisgemaakte taarten", "cupcakes", "macarons", "online bestellen"], keywords: ["taart bestellen", "cupcakes bestellen", "macarons", "thuisbakkerij"],
    relatedTopics: ["feestelijke zoetigheden", "maatwerk taart", "bezorgen"], preferredLayouts: ["product-grid", "category-led"],
  }),
  profile("tree-care", {
    industry: "groenbeheer", subcategory: "boomverzorging", assetGroup: "boomverzorging",
    aliases: ["boomverzorging", "boomverzorger", "boombeheer", "boomspecialist", "arborist"],
    positiveSignals: ["boomverzorging", "boomverzorger", "boombeheer", "boomspecialist", "arborist", "boominspectie", "bomen snoeien", "boom snoeien", "bomen kappen", "boom kappen", "stobben frezen", "stormschade", "klimwerk"],
    negativeSignals: ["consultancy", "accountant", "restaurant", "beautysalon", "tandarts"],
    targetAudience: ["particulieren, bedrijven en beheerders met bomen op hun terrein"],
    personality: ["vakkundig", "veilig", "nuchter", "zorgvuldig"],
    tone: ["deskundig", "helder", "lokaal betrokken"],
    trustSignals: ["veilige werkwijze", "duidelijke beoordeling", "vakkundig boomwerk", "netjes opleveren"],
    visualStyle: ["natuurlijk", "robuust", "professioneel"],
    colorPalette: ["#152019", "#28543a", "#d19a47", "#f2f4ed"],
    preferredPhotoTags: ["tree-care", "arborist", "tree-pruning", "climbing", "green-management", "nature"],
    forbiddenPhotoTags: ["office", "consultancy", "beauty", "restaurant", "healthcare"],
    ...
    relatedTopics: ["stormschade", "stobben frezen", "duurzaam groenbeheer"],
    recommendedTemplates: ["starter-one-page-v1", "business-multi-page-v1"],
    preferredLayouts: ["service-led", "project-trust"],
  }),
  profile("carpentry", {
