-- Additive portal review fields for the existing Website Factory preview table.
-- Production preflight confirmed public.website_preview_versions already exists.
