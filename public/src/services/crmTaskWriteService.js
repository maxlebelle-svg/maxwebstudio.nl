...
export function mapCrmTaskToSupabasePayload(task = {}) {
  ...
  const metadata = {
    ...
    dueEndTime: normalized.dueEndTime || "",
    dueAt: normalized.dueAt || "",
    dueEndAt: normalized.dueEndAt || "",
    ownerAuthUserId: normalized.ownerAuthUserId || "",
...
function mapSupabaseRecordToLocalTask(record = {}, fallback = {}) {
  ...
  return normalizeCrmTask({
    ...
    dueTime: metadata.dueTime || fallback.dueTime,
    dueEndTime: metadata.dueEndTime || fallback.dueEndTime,
    dueAt: metadata.dueAt || fallback.dueAt,
    dueEndAt: metadata.dueEndAt || fallback.dueEndAt,
    ownerAuthUserId: metadata.ownerAuthUserId || fallback.ownerAuthUserId,
    ownerEmail: metadata.ownerEmail || fallback.ownerEmail,
    ownerName: metadata.ownerName || fallback.ownerName,
    assignedToEmail: metadata.assignedToEmail || fallback.assignedToEmail,
    assignedToName: metadata.assignedToName || fallback.assignedToName,
