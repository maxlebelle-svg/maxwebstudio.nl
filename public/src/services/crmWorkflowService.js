...
export function normalizeCrmTask(task = {}) {
  ...
  return {
    ...
    dueTime: sanitizeString(task.dueTime),
    dueEndTime: sanitizeString(task.dueEndTime),
    dueAt: sanitizeString(task.dueAt),
    dueEndAt: sanitizeString(task.dueEndAt),
    ownerAuthUserId: sanitizeString(task.ownerAuthUserId),
    ownerEmail: sanitizeString(task.ownerEmail),
    ownerName: sanitizeString(task.ownerName),
    assignedToEmail: sanitizeString(task.assignedToEmail),
    assignedToName: sanitizeString(task.assignedToName),
...
export function getCanonicalCrmRelationships() {
  return [
    ...
    { table: "invoices", source: STORAGE_KEYS.invoices, readiness: "canoniek", note: "Facturen gebruiken het canonieke server-side contract." },
