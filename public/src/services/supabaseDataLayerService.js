...
function mapLead(row = {}, source = "local") {
  ...
  const normalized = normalizeLeadFinderLead({
    ...
    ownerAuthUserId: firstValue(row.ownerAuthUserId, row.owner_id, row.owner_auth_user_id, row.assignedAuthUserId, row.assigned_auth_user_id, row.created_by_auth_user_id, meta.ownerAuthUserId, meta.owner_auth_user_id, meta.createdBy),
