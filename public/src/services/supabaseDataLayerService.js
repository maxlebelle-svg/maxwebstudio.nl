...
function mapLead(row = {}, source = "local") {
  ...
  const normalized = normalizeLeadFinderLead({
    ...
    ownerEmail: firstValue(row.ownerEmail, row.owner_email, row.medewerkerEmail, row.medewerker_email, row.employeeEmail, row.employee_email, row.assignedToEmail, row.assigned_to_email, row.assigned_user_email, row.sales_partner_email, row.userEmail, row.user_email, meta.ownerEmail, meta.owner_email, meta.medewerkerEmail, meta.medewerker_email, meta.employeeEmail, meta.employee_email, meta.assignedToEmail, meta.assigned_to_email, meta.userEmail, meta.user_email, meta.createdByEmail),
    ownerName: firstValue(row.ownerName, row.owner_name, row.medewerker, row.employee, row.assignedToName, row.assigned_to_name, row.assigned_user_name, row.sales_partner_name, row.userName, row.user_name, meta.ownerName, meta.owner_name, meta.medewerker, meta.employee, meta.assignedToName, meta.assigned_to_name, meta.userName, meta.user_name, meta.createdByName),
