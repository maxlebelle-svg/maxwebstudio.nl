...
function mapLead(row = {}, source = "local") {
  ...
  const normalized = normalizeLeadFinderLead({
    id: row.id,
    companyName: firstValue(row.companyName, row.company_name, row.company, row.businessName, row.name),
    ...
    websiteStatus: mapWebsiteStatus(firstValue(row.websiteStatus, row.website_status, meta.websiteStatus, meta.website_status)),
    leadScore: firstValue(row.leadScore, row.lead_score, row.score, meta.leadScore, meta.lead_score),
    callStatus: firstValue(row.callStatus, row.call_status, mapLeadStatus(row.status)),
    followUpDate: firstValue(row.followUpDate, row.follow_up_date, meta.followUpDate, meta.follow_up_date),
    ...
    ownerAuthUserId: firstValue(row.ownerAuthUserId, row.owner_id, row.owner_auth_user_id, row.assignedAuthUserId, row.assigned_auth_user_id, meta.ownerAuthUserId, meta.owner_auth_user_id),
    ...
    ownerEmail: firstValue(row.assignedUserEmail, row.assigned_user_email, meta.assignedUserEmail, meta.assigned_user_email, row.assignedToEmail, row.assigned_to_email, meta.assignedToEmail, meta.assigned_to_email, row.medewerkerEmail, row.medewerker_email, meta.medewerkerEmail, meta.medewerker_email, row.employeeEmail, row.employee_email, meta.employeeEmail, meta.employee_email, row.salesPartnerEmail, row.sales_partner_email, meta.salesPartnerEmail, meta.sales_partner_email, row.ownerEmail, row.owner_email, meta.ownerEmail, meta.owner_email, row.userEmail, row.user_email, meta.userEmail, meta.user_email),
    ownerName: firstValue(row.assignedUserName, row.assigned_user_name, meta.assignedUserName, meta.assigned_user_name, row.assignedToName, row.assigned_to_name, meta.assignedToName, meta.assigned_to_name, row.medewerker, meta.medewerker, row.employee, meta.employee, row.salesPartnerName, row.sales_partner_name, meta.salesPartnerName, meta.sales_partner_name, row.ownerName, row.owner_name, meta.ownerName, meta.owner_name, row.userName, row.user_name, meta.userName, meta.user_name),
    assignedUserEmail: firstValue(row.assignedUserEmail, row.assigned_user_email, row.assignedToEmail, row.assigned_to_email, row.medewerkerEmail, row.medewerker_email, row.employeeEmail, row.employee_email, meta.assignedUserEmail, meta.assigned_user_email, meta.assignedToEmail, meta.assigned_to_email, meta.medewerkerEmail, meta.medewerker_email, meta.employeeEmail, meta.employee_email),
    assignedUserId: firstValue(row.assignedUserId, row.assigned_user_id, meta.assignedUserId, meta.assigned_user_id),
    assignedUserName: firstValue(row.assignedUserName, row.assigned_user_name, row.assignedToName, row.assigned_to_name, row.medewerker, row.employee, meta.assignedUserName, meta.assigned_user_name, meta.assignedToName, meta.assigned_to_name, meta.medewerker, meta.employee),
    ...
    assignedTo: firstValue(row.assignedTo, row.assigned_to, meta.assignedTo, meta.assigned_to),
    websiteAnalysis: firstValue(row.websiteAnalysis, row.website_analysis, meta.websiteAnalysis, meta.website_analysis),
    metadata: meta,
