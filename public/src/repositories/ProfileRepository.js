...
export function mapLocalProfileToSupabase(profile = {}) {
  ...
  return {
    ...
    package: normalized.package || null,
    last_login_at: normalized.lastLoginAt || null,
...
export function mapSupabaseProfileToLocal(row = {}) {
  ...
  return normalizeProfile({
    ...
    lastLoginAt: row.last_login_at || metadata.lastLoginAt || "",
    createdBy: row.created_by || metadata.createdBy || "",
