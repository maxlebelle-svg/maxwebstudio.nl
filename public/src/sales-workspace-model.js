(function salesWorkspaceModel(root, factory) {
  ...
  const SMART_VIEWS = Object.freeze([
    ...
    ["callback", "Terugbellen"], ["voicemail", "Voicemails"], ["hot", "Warme leads"],
    ["demos", "Demo’s"], ["payment", "Wacht op betaling"], ["customers", "Klanten"], ["closed", "Afgesloten"],
  ].map(([value, label]) => Object.freeze({ value, label })));
  ...
  function normalizeLead(lead = {}) {
    ...
    return { ...lead, pipelineStage, callDisposition: callStatus, interestLevel, priority, nextActionAt, leadScore: score };
  }
  ...
  return Object.freeze({ PIPELINE_STAGES, SMART_VIEWS, normalizeLead, needsActionToday, matchesSmartView, matchesFilters, smartViewCounts, kpiCounts, paginate, dayKey });
});
