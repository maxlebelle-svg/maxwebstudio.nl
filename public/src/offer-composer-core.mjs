...
export function definitiveConfirmationDetails({ relationship = {}, demo = {}, snapshot = {} } = {}) {
  ...
  return {
    ...
    oneTimeBeforeDiscountExVatCents: Number(snapshot.oneTimeBeforeDiscountExVatCents ?? snapshot.oneTimeExVatCents ?? 0),
    discountPercentage: Number(snapshot.discountPercentage || 0),
    discountExVatCents: Number(snapshot.discountExVatCents || 0),
