  ...
  const ADMIN_SIDEBAR_NAVIGATION = Object.freeze([
    ...
    Object.freeze({
      ...
      items: Object.freeze([
        ...
        item("offer-composer", "Voorstel maken", "admin-offer-composer.html", "pen-line", { relationshipTypes: ["lead", "customer"], permission: permission("quotes", "create", roleGroups.sales) }),
