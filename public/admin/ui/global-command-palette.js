(function initMaxCommand() {
  ...
  const PAGE_RESULTS = [
    ...
    ["commercial-order", "Open Voorstellen", "Stel een controleerbaar voorstel samen", "admin-offer-composer.html", "Voorstellen", "Page"],
  ...
  const COMMANDS = [
    ...
    ["new-commercial-order", "Nieuw voorstel", "Open de Voorstel Composer", "Voorstellen", "Command", "admin-offer-composer.html"],
    ...
    ["open-upsells", "Open upsells", "Open upsell kansen", "Growth", "Command", "admin-offer-composer.html"],
